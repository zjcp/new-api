        ...
        <div className='w-full overflow-x-hidden'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
                <div className='lg:col-span-7'>
                  ...
                  <p
                    ...
                    style={{
                      color: actualTheme === 'dark' ? '#cbd5e1' : '#4b5563',
                    }}
                  >
                    {t(
                      '全网最稳定的官方企业级 1000 Mbps 带宽中转，触达8个地区 20万+ 客户。 注册即送 $0.2，明码实价，绝对不搞虚的，36个月 稳定运营。',
                    )}
                  </p>
                  <div className='flex flex-wrap gap-4 mb-12'>
                    ...
                    {docsLink && (
                      <Button
                        size='large'
                        className='!px-8 !py-6 !text-lg !rounded-xl !text-blue-600 !border-blue-600 hover:!bg-blue-600 hover:!text-white'
                        icon={<IconFile />}
                  ...
                  <div
                    className='flex gap-8 md:gap-12 pt-8 border-t'
                    style={{
                      borderColor:
                        actualTheme === 'dark' ? '#334155' : '#cdcdcd',
                    }}
                  >
                    <div className='text-center'>
                      <div
                        className='inline-block px-3 py-2 rounded-xl bg-blue-50 dark:bg-blue-900/30 text-3xl font-bold'
                        style={{ color: '#2563eb' }}
                      >
                        100+
                      </div>
                ...
                <div className='hidden lg:block lg:col-span-5 relative'>
                  <div className='bg-[#1e293b] rounded-2xl p-6 shadow-lg'>
                    ...
                    <pre className='bg-[#0f172a] rounded-xl p-4 font-mono text-xs leading-relaxed overflow-x-auto text-[#c9d1d9] m-0'>
                      ...
                      {'\n\n'}
                      <span className='text-[#79c0ff]'>from</span>{' '}
                      ...
                      {'\n'}){'\n\n'}
                      <span className='text-[#d2a8ff]'>response</span> ={' '}
                      <span className='text-[#ff7b72]'>client</span>
                      ...
                      <span className='text-[#a5d6ff]'>"hi"</span>
                      {`}`}] ){'\n\n'}
          ...
          >
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              <h2
                ...
                style={{
                  color: actualTheme === 'dark' ? '#f8fafc' : '#1f2937',
                }}
              >
                {t('为什么选择我们')}
              </h2>
              ...
              >
                {t('稳定、高效、低成本，一站式 AI 解决方案')}
              </p>
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                {[
                  {
                    title: t('极速响应'),
                    desc: t('平均响应时间 < 100ms，全球CDN加速，让AI触手可及'),
                    score: 95,
                    iconBg: '#fef3c7',
                    iconColor: '#d97706',
                    barColor: 'bg-gradient-to-r from-blue-600 to-emerald-500',
                    svg: <path d='M13 2 3 14 12 14 11 22 21 10 12 10 13 2' />,
                  },
                  {
                    title: t('企业级安全'),
                    desc: t('银行级加密传输，完善的权限管理，保障数据安全'),
                    score: 99,
                    iconBg: '#dcfce7',
                    iconColor: '#16a34a',
                    barColor: 'bg-gradient-to-r from-blue-600 to-emerald-500',
                  ...
                  <div
                    key={i}
                    className='rounded-2xl p-8 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300'
                    style={{
                      backgroundColor:
                  ...
                  >
                    ...
                    <div
                      style={{
                        height: '8px',
                        backgroundColor:
                          actualTheme === 'dark' ? '#334155' : '#e5e7eb',
                        borderRadius: '9999px',
                        overflow: 'hidden',
                      }}
                    >
          ...
          >
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              >
                {t('连接全球顶级AI模型，统一接口调用，让您的应用具备无限可能')}
              </p>
              <div className='grid grid-cols-5 sm:grid-cols-5 md:grid-cols-8 lg:grid-cols-10 gap-3 max-w-6xl mx-auto justify-items-center'>
                <div
                  className='w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-2xl shadow-md flex items-center justify-center hover:scale-110 transition-transform duration-300 cursor-pointer'
                  style={{
                    background:
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #dbeafe 0%, #67e8f9 100%)',
                  }}
                >
                  <Zhipu.Color size={40} />
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(135deg, #ccfbf1 0%, #cffafe 100%)',
                  }}
                >
                ...
                >
                  <span
                    ...
                    style={{
                      color: actualTheme === 'dark' ? '#f8fafc' : '#374151',
                    }}
                  >
                    30+
                  </span>
              ...
              <div className='mt-8 text-center'>
                <a
                  href='https://atokenapi.com/pricing'
                  target='_blank'
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                <div className='text-center p-8'>
                  <div
                    className='w-12 h-12 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6'
                    style={{
                      color: '#ffffff',
                      background:
                ...
                <div className='text-center p-8'>
                  ...
                  >
                    {t('在控制台创建 API Key，完全兼容 OpenAI 格式')}
                  </p>
                </div>
                <div className='text-center p-8'>
                  <div
          ...
          >
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              >
                {t('新用户注册即送 0.2 美元体验额度，无门槛试用')}
              </p>
              <Link to='/console'>
                <button
                  className='px-10 py-4 text-lg font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1'
